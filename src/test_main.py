...
from main import text_node_to_html_node, split_nodes_delimiter, extract_markdown_links, extract_markdown_images, \
    ...
    block_to_block_type, BlockType, heading_text_to_heading_leafnode, markdown_to_html_node, extract_title
...
- It created an entirely new genre of fantasy        
        ...
        self.assertEqual(
            html,
            "<div><ul><li>You can spend years studying the legendarium and still not understand its depths</li><li>It can be enjoyed by children and adults alike</li><li>Disney <i>didn't ruin it</i> (okay, but Amazon might have)</li><li>It created an entirely new genre of fantasy</li></ul></div>",
        )
...
> Everything is going according to plan.
        ...
        node = markdown_to_html_node(md)
        html = node.to_html()
        self.assertEqual(html, "<div><blockquote>The quarterly results look great!<p></p><p>Revenue was off the chart.</p><p>Profits were higher than ever.</p><p></p><p>Everything is going according to plan.</p></blockquote></div>")


    def test_unordered_list_of_link(self):
        md = """
...
- [What is HTML?](https://en.wikipedia.org/wiki/HTML)
        ...
        self.assertEqual(
            html,
            "<div><ul><li><a href=\"https://en.wikipedia.org/wiki/Markdown\">What is Markdown?</a></li><li><a href=\"https://en.wikipedia.org/wiki/HTML\">What is HTML?</a></li></ul></div>",
        )
        
    def test_whole_index_md(self):
        md = """
# Tolkien Fan Club
...
This site was generated with a custom-built [static site generator](https://www.boot.dev/courses/build-static-site-generator-python) from the course on [Boot.dev](https://www.boot.dev).        
        ...
        node = markdown_to_html_node(md)
        html = node.to_html()
        self.assertTrue(html.startswith("<div><h1>Tolkien Fan Club</h1><p><img alt=\"JRR Tolkien sitting\" src=\"/images/tolkien.png\">"))
